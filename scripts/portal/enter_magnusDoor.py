...
destinations = [
    ["Normal", 160, 401060200, BossConstants.MAGNUS_DEATHCOUNT, EventType.NMagnus, 64800000],
    ["Hard", 220, 401060100, BossConstants.MAGNUS_DEATHCOUNT, EventType.HMagnus, 64800000],
]
